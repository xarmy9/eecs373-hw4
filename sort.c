...
__attribute__((weak))
int compare_for_qsort(void* a, void* b)
{
    return *((int*)a) - *((int*)b);
}

void do_qsort(int* nums, unsigned count)
{
    qsort(nums, count, sizeof(int), compare_for_qsort);
}
...
sorting_fn sorting_fns[] = {bubble_sort, insertion_sort, do_qsort, NULL};
